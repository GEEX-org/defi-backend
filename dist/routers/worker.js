...
router.post("/payout", middleware_1.workerMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const transaction = new web3_js_1.Transaction().add(web3_js_1.SystemProgram.transfer({
        fromPubkey: new web3_js_1.PublicKey("5vrRuAhK2TthC9HrXwRaxLPNw88xe9dfe4SwReDQPQmB"), //parent address
        toPubkey: new web3_js_1.PublicKey(worker.address), //to worker
