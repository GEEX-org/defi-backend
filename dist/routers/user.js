...
const DEFAULT_TITLE = "Select the most attractive content";
const s3Client = new client_s3_1.S3Client({
    credentials: {
        accessKeyId: (_b = process.env.ACCESS_KEY_ID) !== null && _b !== void 0 ? _b : "",
        secretAccessKey: (_c = process.env.SECRET_ACCESS_KEY) !== null && _c !== void 0 ? _c : "",
    },
    region: "us-east-1"
});
...
router.post("/task", middleware_1.authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    //     })
    // }
    if (((_a = transaction === null || transaction === void 0 ? void 0 : transaction.transaction.message.getAccountKeys().get(1)) === null || _a === void 0 ? void 0 : _a.toString()) !== PARENT_WALLET_ADDRESS) {
        return res.status(411).json({
            message: "Transaction sent to wrong address"
        });
    }
    if (((_b = transaction === null || transaction === void 0 ? void 0 : transaction.transaction.message.getAccountKeys().get(0)) === null || _b === void 0 ? void 0 : _b.toString()) !== (user === null || user === void 0 ? void 0 : user.address)) {
        return res.status(411).json({
            message: "Transaction sent to wrong address"
        });
    }
